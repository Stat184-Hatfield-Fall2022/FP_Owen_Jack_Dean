...
```{r}
ggplot(data = AllTeamsStats, aes(x= AllTeamsStats[[2]], y =AllTeamsStats[[3]], color =AllTeamsStats[[1]], size =AllTeamsStats[[4]])) + scale_x_discrete(guide = guide_axis(n.dodge=3)) + geom_point()  + xlab("PCT(Win Rate)")+ ylab("RS(Runs Scored")+ ggtitle("AllTeams Win Rate per Runs scored)") +labs(color = "Teams") + labs(size = "RA(Runs Allows)")
```
...
```{r}
ggplot(data = PlayoffLeagueStats, aes(x= PlayoffLeagueStats[[2]], y =PlayoffLeagueStats[[3]], color =PlayoffLeagueStats[[1]], size =PlayoffLeagueStats[[4]])) + geom_point()  + xlab("PCT(Win Rate)")+ ylab("RS(Runs Scored)")+ ggtitle("American League Teams Win Rate per Runs scored") +labs(color = "Teams") + labs(size = "RA(Runs Allows)")
```

## National Play off Teams chart
```{r}
ggplot(data = NationalPlayoffTeams, aes(x= NationalPlayoffTeams[[2]], y =NationalPlayoffTeams[[3]], color =NationalPlayoffTeams[[1]], size =NationalPlayoffTeams[[4]])) + geom_point()  + xlab("PCT(Win Rate)")+ ylab("RS(Runs Scored)")+ ggtitle("American League Teams Win Rate per Runs scored") +labs(color = "Teams") + labs(size = "RA(Runs Allows)")
```
