...
```{r}
ggplot(data = AllTeamsStats, aes(x= AllTeamsStats[[2]], y =AllTeamsStats[[3]], color =AllTeamsStats[[1]], size =AllTeamsStats[[4]])) + geom_point()  + xlab("PCT(Win Rate)")+ ylab("RS(Runs Scored")+ ggtitle("AllTeams Win Rate per Runs scored")
```

```{r}
ggplot(data = NationalLeagueTeams, aes(x= NationalLeagueTeams[[2]], y =NationalLeagueTeams[[3]], color =NationalLeagueTeams[[1]], size =NationalLeagueTeams[[4]])) + geom_point()  + xlab("PCT(Win Rate)")+ ylab("RS(Runs Scored")+ ggtitle("National League Teams Win Rate per Runs scored")
```
